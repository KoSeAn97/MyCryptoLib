const unsigned BLOCK_LENGTH = 512;
inline unsigned LEN_IN_BYTES(unsigned l) { return l >> 6; }

const unsigned PI_LENGTH = 256;
const byte SUBSTITUTION_PI [ PI_LENGTH ] =
{
...
const unsigned TAU_LENGTH = 64;
const byte PERMUTATION_TAU [ TAU_LENGTH ] =
{
...
const unsigned LINEAR_TRANSFORMATION_LENGTH = 64;
const unsigned BYTES_IN_ROW = 8;
const byte LINEAR_TRANSFORMATION [ LINEAR_TRANSFORMATION_LENGTH ][ BYTES_IN_ROW ] =
{
...
const unsigned AMOUNT_OF_ITER_CONSTS = 12;
const unsigned BYTES_IN_ITER_CONST = 64;
const byte ITER_CONSTS [ AMOUNT_OF_ITER_CONSTS ][ BYTES_IN_ITER_CONST ] =
{
    {
